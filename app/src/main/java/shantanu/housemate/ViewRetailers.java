...
public class ViewRetailers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retailerListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view, final int position, long id) {
                final PopupMenu popupMenu = new PopupMenu(ViewRetailers.this, view, Gravity.CENTER);
                ...
                MenuPopupHelper menuHelper = new MenuPopupHelper(ViewRetailers.this, (MenuBuilder)
