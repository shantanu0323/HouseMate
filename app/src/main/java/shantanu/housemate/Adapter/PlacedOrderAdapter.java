 ...
 */
public class PlacedOrderAdapter extends ArrayAdapter<GenerateListData> {

    public PlacedOrderAdapter(Context context, int resource, List<GenerateListData> groceryDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.placed_order_item_layout, parent, false);
        }
